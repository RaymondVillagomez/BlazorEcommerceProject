...
namespace BlazorEcommerceProject.Server.Migrations
{
    ...
    [Migration("20230922144629_ProductVariants")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorEcommerceProject.Shared.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorEcommerce.Shared.ProductVariant", b =>
                {
                    b.HasOne("BlazorEcommerceProject.Shared.Product", "Product")
                        .WithMany("Variants")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlazorEcommerceProject.Shared.ProductType", "ProductType")
                        .WithMany()
